...
namespace LYFrame
{
	public class UnityHelper : MonoBehaviour {
        ...
        {
            if (goParent == null || string.IsNullOrEmpty(chiildName))
                return null;
        ...
        ///// <returns></returns>
        //public static List<T> GetAllChildNodeComponetScripts<T>(GameObject goParent) where T : Component
        //{
        //   goParent.GetComponentsInChildren<T>
        //}
